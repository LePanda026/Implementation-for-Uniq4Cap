...
from lavis.models.encoder import VideoProcessor,AudioProcessor
from lavis.models.encoder import VideoProcessor,AudioProcessor

from lavis.models.mm_blip2_models.mm_blip2 import (
    Blip2Base,
    compute_sim_matrix,
    disabled_train,
)
...
class Blip2Qformer(Blip2Base):
    ...
    def forward(self, samples):
        ...
        video_output = video_output.reshape(audio_output.shape[0],-1,1024)
