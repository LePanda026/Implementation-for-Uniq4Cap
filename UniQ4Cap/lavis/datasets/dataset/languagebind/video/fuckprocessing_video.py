...
class fuckLanguageBindVideoProcessor(ProcessorMixin):
    attributes = []
    ...
    def __call__(self, images=None,  **kwargs):
            ...
            image_features = [load_and_transform_video(image, self.transform,
                                                   video_decode_backend=self.config.video_decode_backend,
                                                   num_frames=self.config.num_frames) for image in images]
