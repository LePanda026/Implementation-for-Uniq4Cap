...
class RunnerBase:
    ...
    def train_loader(self):
        sampler = DistributedSampler(self.datasets['train'], shuffle=True, num_replicas=get_world_size(), rank=get_rank())
        loader = DataLoader(self.datasets['train'], batch_size=20, num_workers=8, pin_memory=True, sampler=sampler, shuffle=False,
